<template>
   <div class="header" >
    <div class="ipo_header con" :class="{ 'open': isActive }">
      <div class="ipo_nv_section">
  ...
  .ipo_header {
    .ipo_nv_section{
        ...
        .burger-line1,.burger-line2, .burger-line3 {
            width: 20px;
            height: 2px;
            background: linear-gradient(90deg, #8AAFFF 0%, #5A7FF5 100%);
        }
        .burger-line1 {
            position: absolute;
            top: -6px;

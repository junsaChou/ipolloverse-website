  ...
  <div class="ipo_main">
    ...
    <div class="demo_collapse con">
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        ...
        <el-collapse-item
          title="2.Why should you need to bind wallet?"
          name="2"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="3.How should you do if you bind a wrong wallet?"
          name="3"
        >
          <div class="tl">
          You can recreate an account and bind the correct wallet and your machine with this new account, as currently iPolloverse does not support unbinding wallet.
            ...
            <el-collapse-item
          title="4.What the computing power suppliers can do when running a node and facing an issue?"
          name="4"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="5.What operation systems can testnet 1 support?"
          name="5"
        >
          <div  class="tl">
        ...
        <el-collapse-item
          title="6.Does iPolloverse support WSL/WSL1 (Windows Subsystem for Linux)?"
          name="6"
        >
          <div  class="tl">
        ...
        <el-collapse-item
          title="7.A node has already been registered and connected to iPolloverse chain. Does the computing power supplier need to re-download installation package, what can s/he do?"
          name="7"
        >
          <div  class="tl">
        ...
        <el-collapse-item
          title="8.After the computing power node connects to the chain, why the node configuration info, such as GPU or CPU, is not displayed in the miner login page?"
          name="8"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="9.When using AMD GPU for mining, the GPU value in the miner login interface show 0. Why does this happen? Does it affect my mining?"
          name="9"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="10.Is there any requirement for public IP address in testnet 1?"
          name="10"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="11.Can iPolloverse network recover a user’s password if s/he forgot his/her password?"
          name="11"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="12.Why is the script file in the preview of testnet 1 not workable in testnet 1 and you need to re-download the script file in testnet 1?"
          name="12"
        >
          <div class="tl">
    ...
    <div class="demo_collapse con">
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        ...
        <el-collapse-item
          title="6.当前支持WSL/WSL1 (Windows Subsystem for Linux)吗？"
          name="6"
        >
          <div  class="tl">
        ...
        <el-collapse-item
          title="7.设备已经注册了节点，并连到iPolloverse网络。需要重新下载安装包时，怎么做？"
          name="7"
        >
          <div  class="tl">
        ...
        <el-collapse-item
          title="8.节点接入网络后，为什么算力提供方登录页面没有显示CPU/GPU算力配置？"
          name="8"
        >
          <div class="tl">
         ...
         <el-collapse-item
          title="9.为什么用AMD的GPU挖矿，算力提供方登录界面里面的GPU为什么显示0？对挖矿有影响没有？"
          name="9"
        >
          <div class="tl">
        ...
        <el-collapse-item
          title="12.预览测试的脚本为什么不能正常工作，在一测脚本文件需要重新下载了？"
          name="12"
        >
          <div class="tl">
